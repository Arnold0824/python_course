...
# %% Cell 2: 准备共享变量和清理函数
os.makedirs("output/ch02", exist_ok=True)
...
# %% Cell 11: 切换到“只保留最新帧”的队列模式
image_queue = queue.Queue(maxsize=1)
camera.listen(push_latest_image)
print("相机已切换到队列模式")


# %% Cell 12: 进入同步模式并稳定取一帧
settings = world.get_settings()
...
# %% Cell 15: 定义“切天气 + tick 几帧 + 保存一张图”的函数
